...
// create element
function createElement(type, identifier, content, position) {
  ...
  null !== position ? document.querySelector('.' + position || '#' + position).appendChild(el) : document.body.appendChild(el);
  return el;
}
